...
class TestCSharpCompilationUnitToSingleFileWithLLM(unittest.TestCase):
    ...
    def test_execute_small_file(self):
        strategy = CSharpCompilationUnitToSingleFileWithLLMProxy(load_resource_migration_spec('ShortClassNoNamespace.cs'), self.config)
        strategy.execute()
    ...
    def test_execute_large_file(self):
        ...
        strategy = CSharpCompilationUnitToSingleFileWithLLMProxy(load_resource_migration_spec('LongClassWithNamespace.cs'), self.config)
        strategy.execute()
